...
class HelloWorldClient implements HelloWorldIf {
  ...
  public function send_sayHello($name)
  {
    ...
    $args->name = $name;
    $bin_accel = (0 && $this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = (0 && $this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Services.HelloWorld_HelloWorld_sayHello_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
...
class HelloWorldProcessor {
  ...
  protected function process_sayHello($seqid, $input, $output) {
    ...
    $bin_accel = (0 && $output instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
